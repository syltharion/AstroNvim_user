return {
  ...
  opts = function(_, opts)
    ...
    opts.cmake_soft_link_compile_commands = false -- this will automatically make a soft link from compile commands file to project root dir
    opts.cmake_compile_commands_from_lsp = true -- this will automatically set compile commands file location using lsp, to use it, please set 'cmake_soft_link_compile_commands' to false

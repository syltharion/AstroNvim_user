if true then return {} end  -- disable for now, jdtls is hard to configure
return {
  ...
  opts = function(_, opts)
    ...
    return utils.extend_tbl({
      cmd = {
        ...
        "-javaagent:/Users/riley/.local/share/nvim/mason/share/jdtls/lombok.jar",
        "-Xbootclasspath/a:/Users/riley/.local/share/nvim/mason/share/jdtls/lombok.jar",
        "-jar",
      ...
      settings = {
        java = {
          project = { -- 是否有这个选项
            referencedLibraries = {
              "/Users/Syltharion/Library/Android/sdk/platforms/android-34/android.jar",
            },
          },
